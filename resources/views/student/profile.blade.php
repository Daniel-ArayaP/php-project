        ...
        <div class="row">
            ...
            <div class="tab-content">
                ...
                <div id="personal" class="tab-pane fade in active">
                    <form method="POST" action="{{ route('editStudentProfile') }}" enctype='multipart/form-data'>
                        {{ csrf_field() }}
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="field form-group{{ $errors->has('curriculum') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <a href="{{ route('downloadCurriculum',[$student->id]) }}" type="button" class="btn btn-info">{{$student['curriculum']}}</a>
                                ...
                                <div class="col-md-6">
                                    <select id="tutor" class="form-control  field-input" name="tutor">
                                        ...
                                        @foreach ($tutors as $tutor)
                                            @if ($student->tutor['person_profile_id'] == $tutor['person_profile_id'])
