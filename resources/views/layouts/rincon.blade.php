            ...
            <div class="col-lg-12">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand">
                        <img src="{{asset('images/logo1.png')}}" style="height: 35px;" />
                    </a>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-3">
                    ...
                    <div class="title">Rinc&oacute;n acad&eacute;mico</div>

                    <div class="list-group">
                        <a href="{{ url('/rincon/inicio') }}" class="list-group-item active">
                            <i class="fas fa-folder-open"></i> Inicio
                        </a>
                        @if (isset($menu_izq))
                            @foreach ($menu_izq as $item)
                                <a href="{{ url('forum/' . $item->id . '/titles') }}" class="list-group-item">{{$item->title}}</a>
                            @endforeach
                        @endif
                   </div>
                    ...
                    <div class="list-group">
                            <a href="{{route('forum')}}" class="list-group-item"><i class="fas fa-comments"></i> Inicio</a>
                            @if (Auth::user()->role_id == 1) 
                                <a href="{{route('adminForumCategroies')}}" class="list-group-item"><i class="fas fa-align-justify"></i> Crear Categor&iacute;as</a>
                                <a href="{{route('adminForumTitles')}}" class="list-group-item"><i class="fas fa-bolt"></i> Crear T&iacute;tulos</a>
                            @endif
                    </div>
