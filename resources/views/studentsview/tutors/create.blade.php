...
<div class="container-fluid">
    <form method="POST" action="{{ route('storeTutor') }}">
        {{ csrf_field() }}
        @if (isset($tutor->person_profile_id))
        ...
        <div class="form-horizontal">
            <div class="form-group{{ $errors->has('firstName') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    @if (isset($tutor->profile['first_name'])) 
                        <input id="firstName" type="text" class="form-control" name="firstName" value="{{ $tutor->profile['first_name'] }}" required autofocus>
                    @else
            ...
            <div class="form-group{{ $errors->has('lastName1') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    @if (isset($tutor->profile['last_name1'])) 
                        <input id="lastName1" type="text" class="form-control" name="lastName1" value="{{ $tutor->profile['last_name1'] }}" required autofocus>
                    @else
            ...
            <div class="form-group{{ $errors->has('lastName2') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    @if (isset($tutor->profile['last_name2'])) 
                        <input id="lastName2" type="text" class="form-control" name="lastName2" value="{{ $tutor->profile['last_name2'] }}" required autofocus>
                    @else
            ...
            <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    @if (isset($tutor->profile['phone'])) 
                        <input id="phone" type="text" class="form-control" name="phone" value="{{ $tutor->profile['phone'] }}" required autofocus>
                    @else
            ...
            <div class="form-group{{ $errors->has('identification_document') ? ' has-error' : '' }}">
                <label for="identification_document" class="col-md-4 control-label">Cédula</label>

                <div class="col-md-6">
                    @if (isset($tutor->identification_document)) 
                        <input id="identification_document" type="text" class="form-control" name="identification_document" value="{{ $tutor->identification_document }}" required autofocus>
                    @else
            ...
            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    @if (isset($tutor->email)) 
                        <input id="email" type="text" class="form-control" name="email" value="{{ $tutor->email }}" required autofocus>
                    @else
