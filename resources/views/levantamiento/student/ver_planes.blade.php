            ...
            <div class="panel panel-green">
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <div class="row show-grid">
                            <div class="col-xs-12 col-md-6">
                                <label for="carrera"><u>Carrera:</u> @foreach ($carrer as $car)
                                    {{ $car->nombre_carreras_ulatina }}
                                    @endforeach </label>
                            </div>
                            <div class="col-xs-12 col-md-6">
                                <label for="plan"><u>Plan de estudio:</u>
                                    @foreach ($plan as $pl)
                                    {{ $pl->nombre_plan }}
                                    @endforeach </label>
                            </div>
                    ...
                    <div class="row show-grid" style="margin-top: 4rem;margin-bottom:4rem;">
                        <div class="col-md-12">
                            <input class="btn btn-primary btn-block" id="ver" type="button" name="ver" value="Regresar" onclick="location='{{route('consultar-plan-get')}}'">
                        </div>
                    </div>
