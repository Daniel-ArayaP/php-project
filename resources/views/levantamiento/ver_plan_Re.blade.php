                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <div class="row show-grid" >
                            ...
                            <label for="sede"><u>Carrera:</u> @foreach ($carrer as $car)
                                    {{ $car->nombre_carreras_ulatina }}
                                    @endforeach </label></div>
                            <div class="col-xs-12 col-md-6">
                            <label for="sede"><u>Plan de estudios:</u> @foreach ($plan as $pl)
                                    {{ $pl->nombre_plan }}
                                    @endforeach </label></div>
                        </div>
                    ...
                    <div class="row show-grid" style="margin-top: 4rem;margin-bottom:4rem;">
                        <div class="col-md-12">
                            ...
                            <input class="btn btn-sm btn-primary-ulat" id="ver" type="button" name="ver" value="Regresar" onclick="location='{{route('consultar')}}'">
                        </div>
                    </div>
