    ...
    @endif
        ...
        <div class="row">
            <ul class="nav nav-tabs">
                ...
                @if (isset($project) and \Illuminate\Support\Facades\Auth::user()->role_id == 1)
                <li><a data-toggle="tab" href="#status">Estado del Proyecto</a></li>
                @endif
            </ul>
            <div class="tab-content">
                ...
                <div id="project" class="tab-pane fade">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group{{ $errors->has('projectName') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                @if (isset($project->title))
                                    <input id="projectName" type="text" class="form-control" name="projectName" value="{{ $project->title }}" required autofocus>
                                @else
                        ...
                        <div class="form-group{{ $errors->has('projectFile') ? ' has-error' : '' }}">
                            <label for="projectFile" class="col-md-4 control-label">Archivo del proyecto</label>
                             ...
                             <div class="col-md-6">
                                ...
                                @if ($errors->has('projectFile'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('projectFile') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="form-group col-md-2">
                    <button type="submit" class="btn btn-sm btn-primary">GUARDAR DATOS !!</button>
                     <a class="btn btn-danger" href="{{ route('project') }}">Cancelar</a>
                </div>
            </div>
        </form>
            @if (isset($project) and \Illuminate\Support\Facades\Auth::user()->role_id == 1)
            ...
            <div class="form-horizontal">
                <form method="POST" action="{{ route('statusProject', ['id' => $project->id]) }}">
                    {{ csrf_field() }}
                    <div class="form-group{{ $errors->has('pLimitations') ? ' has-error' : '' }}">
                        <label for="status" class="col-md-4 control-label">Cambiar Estado: </label>

                        <div class="col-md-3">
                            <input type="submit" name="status" class="btn btn-primary-ulat" value="Aprobado">
                        </div>
                        <div class="col-md-3">
                            <input type="submit" name="status" class="btn btn-danger" value="Rechazado">
                            <input type="hidden" class="project-status" value="">
                        </div>
                    </div>
                </form>
            </div>
