    ...
    <div class="row">
        ...
        <div class="tab-content">
            ...
            <h2 align="center">Curso</h2>
                ...
                <form method="POST" action="{{ route('updateCourse') }}" onsubmit="return guardar_info()">
                    {{ csrf_field() }}
                    ...
                    <div class="form-horizontal">
                        <div class="form-group{{ $errors->has('courseName') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                    ...
                                    <input id="courseName" type="text" class="form-control" name="courseName" value="{{ $courses->nombre_cursos }}" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('courseCode') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                    ...
                                    <input id="courseCode" type="text" class="form-control" name="courseCode" value="{{ $courses->codigo_cursos }}" readonly="readonly"  autofocus>
                        ...
                        <div class="form-group{{ $errors->has('courseGroup') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="courseGroup" type="text" class="form-control" name="courseGroup" value="{{ $courses->grupo_cursos }}" autofocus>
                        ...
                        <input type="text" name="courseGroup" value="{{ $courses->grupo_cursos }}" hidden>
                        @endif
                        @if(Auth::user()->role_id == 1)
                            ...
                            <div class="col-md-6">
                              <select id="courseTeacher" class="form-control" name="courseTeacher">
                                  ...
                                  @foreach ($profesores as $prof)
                                         @if ($courses->profesores_id_profesores == $prof->id_profesores)
                        ...
                        @elseif(Auth::user()->role_id == 4)
                        <input type="hidden" name="courseTeacher" value="{{$courses->profesores_id_profesores}}">
                        @endif
                        @if(Auth::user()->role_id == 1)
                        <div class="form-group{{ $errors->has('courseStatus') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                              <select id="courseInstitute" class="form-control" name="courseInstitute">
                                  ...
                                  @foreach ($institutos as $inst)
                                         @if ($courses->solicitado_por == $inst->id_institutos)
                            ...
                            <div class="col-md-6">
                              <select id="courseStatus" class="form-control" name="courseStatus">
                                  ...
                                  @foreach ($estados as $estado)
                                         @if ($courses->status_id == $estado->id)
                        ...
                        @elseif(Auth::user()->role_id == 4)
                        <input type="text" name="courseStatus" value="{{$courses->status_id}}" hidden>
                        @endif
                            ...
                            <div class="col-md-6">
                              <select id="headquarter" class="form-control" name="headquarter">
                                  ...
                                  @foreach ($sedes as $sede)
                                         @if ($courses->sedes_id_sedes == $sede->id_sedes)
            ...
            @endif
                ...
                <div class="container">
                    ...
                    <div class="form-group">
                        <form method="POST" action="{{ route('updateSchedule') }}" name="add_name" id="add_name" onsubmit="return guardar_info()">
                        @if(!is_null($courses))
                        <input name="courses1" id="courses1" type="hidden" value="{{ $courses->id_cursos }}">
                        @endif
            ...
            <h2 align="center">Temas</h2>
                ...
                <form class="form-horizontal" method="POST" action="{{ route('createThemeEdit') }}" onsubmit="return guardar_info()">
                    {{ csrf_field() }}
                    <input name="courses2" id="courses2" type="hidden" value="{{ $courses->id_cursos }}">
                    ...
                    <div class="form-group{{ $errors->has('themeName') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                                ...
                                @foreach($temas as $tema)
                                    @if($tema->cursos_id_cursos == $courses->id_cursos)
            ...
            <form method="POST" action="{{ route('updateInstituteStudentTable') }}" enctype="multipart/form-data" name="add_name" id="add_name" onsubmit="return cedula_unica_y_guardar_info_estudiantes()">
                    {{ csrf_field() }}
                            <div class="row2" >
                                <div class="center container">
                                    <div class="form-group{{ $errors->has('courses3') ? ' has-error' : '' }}">
                                      @if(!is_null($courses))
                                      <input id="courses3" type="text" name="courses3" value="{{$courses->id_cursos}}" hidden />
                                      @endif
                                        <div class="col-md-3">
            ...
            <form class="form-horizontal" method="POST" action="{{ route('updateComments') }}" onsubmit="return guardar_info()">

                    {{ csrf_field() }}
                            <div class="row4" >
                                <div class="center container">
                                    <div class="form-group{{ $errors->has('courses4') ? ' has-error' : '' }}">
                                        <div class="col-md-3">
                                            <input name="courses4" id="courses4" type="hidden" value="{{ $courses->id_cursos }}">
                                            @if ($errors->has('courses4'))
                                                <span class="help-block">
                                                    <strong>{{ $errors->first('courses4') }}</strong>
                                                </span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="form-group{{ $errors->has('courseComments') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-6">
                                            <textarea id="courseComments" name="courseComments" class="form-control my-editor" maxlength="1000" title='Por favor, escriba comentarios sobre el curso.'>{{$courses->comentario_sobre_curso}}</textarea>
