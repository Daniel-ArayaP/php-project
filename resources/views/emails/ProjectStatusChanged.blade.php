        ...
        <tr>
            <td style="padding: 40px; text-align: center; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555;">
                ...
                @if($statusName == "Activo")
                    Es un placer informarle que su proyecto ({{$title}}) fue <b>aprobado</b>, nos pondremos en contacto cuando algún estudiante aplique al mismo.
                @elseif($statusName == "Bloqueado")
                    Lamentamos informarle que su proyecto ({{$title}}) ha sido <b>bloqueado</b>, para más detalles comuníquese con la Universidad.
                    <br><br>
                    <!-- Button : Begin -->
                    <table cellspacing="0" cellpadding="0" border="0" align="center" style="Margin: auto">
                        <tr>
                            <td style="border-radius: 3px; background: #16ba29; text-align: center;" class="button-td">
                                <a href="{{ env('APP_URL') }}" style="background: #16ba29; border: 15px solid #16ba29; font-family: sans-serif; font-size: 13px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" class="button-a">
